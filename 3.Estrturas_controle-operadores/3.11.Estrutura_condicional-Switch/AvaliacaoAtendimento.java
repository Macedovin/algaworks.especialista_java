...
public class AvaliacaoAtendimento {
	...
	public static void main (String[] args) {
		...
		// Não compila com o tipo long 
		// long nota = entrada.nextLong();
		int nota = entrada.nextInt();
		
		// Declaracao de nova variável
		String descricaoNota;
		
		// Encadeamento de IF/ ELSE IFs
		/*
		if (nota == 1) {
		...
		*/
		...
		// Vai ser lida na totalidade, parando no último caso, o DEFAULT
		switch (nota) {
